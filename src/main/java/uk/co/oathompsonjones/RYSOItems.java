...
public class RYSOItems {
    ...
    // Non-sock items
    // TODO: Change food component to wither
    public static final Item CURSED_FLESH = register(new Item(new Item.Settings()
                                                                      ...
                                                                      .food(new FoodComponent.Builder()
                                                                                    ...
                                                                                    .meat()
                                                                                    .build())), "cursed_flesh");
    public static final Item VERTEBRA = register(new Item(new Item.Settings().rarity(Rarity.UNCOMMON)),
                                                 "vertebra"
    );
    public static final Item SOUL_ROD = register(new Item(new Item.Settings().rarity(Rarity.UNCOMMON)),
                                                 "soul_rod"
    );
    public static final Item GUARDIAN_ROD = register(new Item(new Item.Settings().rarity(Rarity.UNCOMMON)),
                                                     "guardian_rod"
    );
    public static final Item SPARK_IN_A_BOTTLE = register(new Item(new Item.Settings()
                                                                           .rarity(Rarity.UNCOMMON)
                                                                           .maxCount(1)), "spark_in_a_bottle");
